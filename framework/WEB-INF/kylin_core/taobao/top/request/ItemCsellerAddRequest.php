...
如果是二手商品，特定类目下属性里面必填新旧成色属性
	...
	public function setSubPicPaths($subPicPaths)
	{
		$this->subPicPaths = $subPicPaths;
		$this->apiParas["sub_pic_paths"] = $subPicPaths;
	}

	public function getSubPicPaths()
	{
	...
	public function check()
	{
		...
		RequestCheckUtil::checkMaxLength($this->type,100,"type");
	}
